...
object Constant {
    ...
    const val PREF_LAST_NOTIFICATION_PERMISSION_CHECK = "PREF_LAST_NOTIFICATION_PERMISSION_CHECK"
    ...
    const val ID_LAUMA = 10000119
    const val ID_FLINS = 10000120
    const val ID_AINO = 10000121
