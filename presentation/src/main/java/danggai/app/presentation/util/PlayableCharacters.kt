...
//    ),
    ...
    LocalCharacter(
        ...
        TalentArea.MONDSTADT,
        TalentDate.TUE_FRI,
        R.drawable.icon_lohen
    ),
    LocalCharacter(
        Constant.ID_SANDRONE,
        "산드로네",
        "Sandrone",
        5,
        Elements.CRYO,
    ...
    LocalCharacter(
        ...
        TalentArea.SNEZHNAYA,
        TalentDate.WED_SAT,
        R.drawable.icon_vesna
    ),
    LocalCharacter(
        Constant.ID_VODYANITSA,
        "보댜니차",
        "Vodyanitsa",
        5,
        Elements.HYDRO,
