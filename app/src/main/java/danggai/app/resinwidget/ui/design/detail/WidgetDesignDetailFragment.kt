        ...
        mVM.lvDetailTimeNotation.observe(viewLifecycleOwner) {
            context?.let { _context ->
                ...
                if (mVM.lvDetailTimeNotation.value == Constant.PREF_TIME_NOTATION_REMAIN_TIME) {
                    ...
                    binding.widget.tvResinTime.text = String.format(getString(R.string.widget_ui_today), 0, "00")
                    ...
                    binding.widget.tvExpeditionTime.text = String.format(getString(R.string.widget_ui_today), 0, "00")
                }
            }
        }
